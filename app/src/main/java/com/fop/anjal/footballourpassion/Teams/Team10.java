...
public class Team10 extends AppCompatActivity {
    ...
    TextView name1,name2,name3,name4,name5,name6,title,name7,total,score1,score2,score3,score4,score5,score6,score7;
    int total_score;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        title.setText("SECOND SON");

        for(int i=0;i<PlayersList.size();i++)
        {
            if((PlayersList.get(i).getEntry()).equals("133834")){
        ...
        for(int i=0;i<PlayersList.size();i++)
        {
            if((PlayersList.get(i).getEntry()).equals("47810")){
        ...
        for(int i=0;i<PlayersList.size();i++)
        {
            if((PlayersList.get(i).getEntry()).equals("105706")){
        ...
        for(int i=0;i<PlayersList.size();i++)
        {
            if((PlayersList.get(i).getEntry()).equals("102")){
