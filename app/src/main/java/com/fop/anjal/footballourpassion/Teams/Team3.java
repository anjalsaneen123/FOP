...
public class Team3 extends AppCompatActivity {
    ...
    TextView name1,name2,name3,name4,title,name5,name6,name7,total,score1,score2,score3,score4,score5,score6,score7;
    int total_score;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        {
            if((PlayersList.get(i).getEntry()).equals("18848")){
        ...
        for(int i=0;i<PlayersList.size();i++)
        {
            if((PlayersList.get(i).getEntry()).equals("2475")){
        ...
        for(int i=0;i<PlayersList.size();i++)
        {
            if((PlayersList.get(i).getEntry()).equals("258027")){
        ...
        for(int i=0;i<PlayersList.size();i++)
        {
            if((PlayersList.get(i).getEntry()).equals("314710")){
        ...
        for(int i=0;i<PlayersList.size();i++)
        {
            if((PlayersList.get(i).getEntry()).equals("2101")){
        ...
        for(int i=0;i<PlayersList.size();i++)
        {
            if((PlayersList.get(i).getEntry()).equals("169616")){
        ...
        for(int i=0;i<PlayersList.size();i++)
        {
            if((PlayersList.get(i).getEntry()).equals("1488")){
